...
submission21 = Submission.create(assignment_id: assignment3.id, student_id: student1.id, body: "Here re some companies researched by me, #{student1.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
submission22 = Submission.create(assignment_id: assignment3.id, student_id: student2.id, body: "Here re some companies researched by me, #{student2.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
submission23 = Submission.create(assignment_id: assignment3.id, student_id: student3.id, body: "Here re some companies researched by me, #{student3.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
submission24 = Submission.create(assignment_id: assignment3.id, student_id: student4.id, body: "Here re some companies researched by me, #{student4.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
# submission25 = Submission.create(assignment_id: assignment3.id, student_id: student5.id, body: "Here re some companies researched by me, #{student5.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
# submission26 = Submission.create(assignment_id: assignment3.id, student_id: student6.id, body: "Here re some companies researched by me, #{student6.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
# submission27 = Submission.create(assignment_id: assignment3.id, student_id: student7.id, body: "Here re some companies researched by me, #{student7.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
# submission28 = Submission.create(assignment_id: assignment3.id, student_id: student8.id, body: "Here re some companies researched by me, #{student8.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
# submission29 = Submission.create(assignment_id: assignment3.id, student_id: student9.id, body: "Here re some companies researched by me, #{student9.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
submission30 = Submission.create(assignment_id: assignment3.id, student_id: student10.id, body: "Here re some companies researched by me, #{student10.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)

...
assignment6 = Assignment.create(name: 'Personal Branding', body: "Hey, branding is important.  Let's personal brand.", due_date: '2019-12-01 00:00:00', cohort_id: cohort2.id, )
...
assignment9 = Assignment.create(name: 'Resume', body: "Resumes are here to stay.  Spend some time polishing up your resume.", due_date: '2019-12-15 00:00:00', cohort_id: cohort2.id, )
...
assignment11 = Assignment.create(name: 'Personal Branding', body: "Hey, branding is important.  Let's personal brand.", due_date: '2019-12-01 00:00:00', cohort_id: cohort3.id, )
...
assignment14 = Assignment.create(name: 'Resume', body: "Resumes are here to stay.  Spend some time polishing up your resume.", due_date: '2019-12-15 00:00:00', cohort_id: cohort3.id, )
...
assignment16 = Assignment.create(name: 'Personal Branding', body: "Hey, branding is important.  Let's personal brand.", due_date: '2019-12-01 00:00:00', cohort_id: cohort4.id, )
...
assignment19 = Assignment.create(name: 'Resume', body: "Resumes are here to stay.  Spend some time polishing up your resume.", due_date: '2019-12-15 00:00:00', cohort_id: cohort4.id, )
...
assignment21 = Assignment.create(name: 'Personal Branding', body: "Hey, branding is important.  Let's personal brand.", due_date: '2019-12-01 00:00:00', cohort_id: cohort5.id, )
...
assignment24 = Assignment.create(name: 'Resume', body: "Resumes are here to stay.  Spend some time polishing up your resume.", due_date: '2019-12-15 00:00:00', cohort_id: cohort5.id, )

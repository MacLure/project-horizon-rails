...
submission4 = Submission.create(assignment_id: assignment1.id, student_id: student1.id, url: '', body: "I, #{student1.first_name}, am truly unique.  It all started when I was young.  Now I'm professional with an interesting back-story.", is_approved: true)
submission5 = Submission.create(assignment_id: assignment1.id, student_id: student2.id, url: '', body: "I, #{student2.first_name} have the best brand.  Nobody has a better brand than me.", is_approved: false)
submission6 = Submission.create(assignment_id: assignment1.id, student_id: student3.id, url: '', body: "I, #{student3.first_name} am new to coding.  It's like this other thing I do which is very on-brand.", is_approved: true)
submission7 = Submission.create(assignment_id: assignment1.id, student_id: student1.id, url: '', body: "I, #{student1.first_name}, am truly unique.  It all started when I was young.  Now I'm professional with an interesting back-story.", is_approved: true)
submission8 = Submission.create(assignment_id: assignment1.id, student_id: student2.id, url: '', body: "I, #{student2.first_name} have the best brand.  Nobody has a better brand than me.", is_approved: false)
# submission9 = Submission.create(assignment_id: assignment1.id, student_id: student3.id, url: '', body: "I, #{student3.first_name} am new to coding.  It's like this other thing I do which is very on-brand.", is_approved: true)
submission10 = Submission.create(assignment_id: assignment1.id, student_id: student3.id, url: '', body: "I, #{student3.first_name} am new to coding.  It's like this other thing I do which is very on-brand.", is_approved: true)
...
# submission14 = Submission.create(assignment_id: assignment2.id, student_id: student1.id, url: "https://www.linkedin.com/in/#{student4.first_name}/", body: "", is_approved: false)
# submission15 = Submission.create(assignment_id: assignment2.id, student_id: student2.id, url: "https://www.linkedin.com/in/#{student5.first_name}/", body: "", is_approved: false)
# submission16 = Submission.create(assignment_id: assignment2.id, student_id: student3.id, url: "https://www.linkedin.com/in/#{student6.first_name}/", body: "", is_approved: false)
submission17 = Submission.create(assignment_id: assignment2.id, student_id: student1.id, url: "https://www.linkedin.com/in/#{student7.first_name}/", body: "", is_approved: false)
submission18 = Submission.create(assignment_id: assignment2.id, student_id: student2.id, url: "https://www.linkedin.com/in/#{student8.first_name}/", body: "", is_approved: false)
submission19 = Submission.create(assignment_id: assignment2.id, student_id: student3.id, url: "https://www.linkedin.com/in/#{student9.first_name}/", body: "", is_approved: false)
submission20 = Submission.create(assignment_id: assignment2.id, student_id: student3.id, url: "https://www.linkedin.com/in/#{student10.first_name}/", body: "", is_approved: false)

submission21 = Submission.create(assignment_id: assignment2.id, student_id: student3.id, body: "Here re some companies researched by me, #{student2.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
submission22 = Submission.create(assignment_id: assignment2.id, student_id: student3.id, body: "Here re some companies researched by me, #{student3.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
...
submission24 = Submission.create(assignment_id: assignment2.id, student_id: student3.id, body: "Here re some companies researched by me, #{student5.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
# submission25 = Submission.create(assignment_id: assignment2.id, student_id: student3.id, body: "Here re some companies researched by me, #{student6.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
# submission26 = Submission.create(assignment_id: assignment2.id, student_id: student3.id, body: "Here re some companies researched by me, #{student7.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
# submission27 = Submission.create(assignment_id: assignment2.id, student_id: student3.id, body: "Here re some companies researched by me, #{student8.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
# submission28 = Submission.create(assignment_id: assignment2.id, student_id: student3.id, body: "Here re some companies researched by me, #{student9.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
# submission29 = Submission.create(assignment_id: assignment2.id, student_id: student3.id, body: "Here re some companies researched by me, #{student10.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
submission30 = Submission.create(assignment_id: assignment2.id, student_id: student3.id, body: "Here re some companies researched by me, #{student11.first_name}:  Uplift Technologies Inc., RefinePro, Blast, Obsidian Solutions, Tasky.me, colorapp.co, JobMart, BlancLink, CreckJack, Varicent Software", url: "", is_approved: false)
...
submission34 = Submission.create(assignment_id: assignment2.id, student_id: student1.id, url: "https://www.linkedin.com/in/#{student4.first_name}/", body: "", is_approved: false)
submission35 = Submission.create(assignment_id: assignment2.id, student_id: student2.id, url: "https://www.linkedin.com/in/#{student5.first_name}/", body: "", is_approved: false)
submission36 = Submission.create(assignment_id: assignment2.id, student_id: student3.id, url: "https://www.linkedin.com/in/#{student6.first_name}/", body: "", is_approved: false)
submission37 = Submission.create(assignment_id: assignment2.id, student_id: student1.id, url: "https://www.linkedin.com/in/#{student7.first_name}/", body: "", is_approved: false)
# submission38 = Submission.create(assignment_id: assignment2.id, student_id: student2.id, url: "https://www.linkedin.com/in/#{student8.first_name}/", body: "", is_approved: false)
# submission39 = Submission.create(assignment_id: assignment2.id, student_id: student3.id, url: "https://www.linkedin.com/in/#{student9.first_name}/", body: "", is_approved: false)
submission40 = Submission.create(assignment_id: assignment2.id, student_id: student3.id, url: "https://www.linkedin.com/in/#{student10.first_name}/", body: "", is_approved: false)
